...
var Colorize = function (o) {
  ...
  var colorize = function (t) {
    ...
    for (var i = 0; i < m.length; i++) {
      ...
      for (var a = 0; a < c.length; a++) {
        if (c[a] == '1') bold = ' font-weight: bold;';
        else if (c[a] == '3') italic = ' font-style: italic;';
        else if (c[a] == '7') flip = 1;
      }
      ...
      for (var a = 0; a < c.length; a++) {
        if (c[a] == '5') {
          if (c[a - 1] == '38') {
            ...
            bgcolor =
              ' background-color:' + colors256[parseInt(c[a + 1])] + ';';
            xterm = 1;
          }
        } else if (!xterm && ansi[c[a]]) {
          if (bold) color = 'color:' + ansi['1;' + c[a]] + ';';
          else color = 'color:' + ansi[c[a]] + ';';
        } else if (!xterm && bgansi[c[a]]) {
          if (bold) bgcolor = ' background-color:' + bgansi['1;' + c[a]] + ';';
          else bgcolor = ' background-color:' + bgansi[c[a]] + ';';
        }
      }

      if (c.has('0') || color || bgcolor) v += '</span>';
    ...
    for (var o in other) {
      re = new RegExp(String.fromCharCode(parseInt('033', 8)) + '\\' + o, 'g');
  ...
  var process = function (t) {
    if (!t.has(String.fromCharCode(parseInt('033', 8)))) return t;
